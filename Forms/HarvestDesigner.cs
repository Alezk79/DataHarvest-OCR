...
namespace TextToDigitalCode
{
    public partial class Form1 : Form
    {
        ...
        private void Save_Click(object sender, EventArgs e)
        {
            ...
            // SaveRectangleData(adjustedRect, rectangleFolder);
        ...
        private void tipoDoctxt_TextChanged(object sender, EventArgs e)
        {
        ...
        {
            OpenOrBringToFront(typeof(Form2));
        }
